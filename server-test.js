...
// // Imported playlists storage helpers
// async function loadImportedPlaylists() {
//     try {
//         const raw = await fs.readFile(IMPORTED_PLAYLISTS_FILE, 'utf-8');
...
//             return [];
//         }
//         console.error(`Error loading ${IMPORTED_PLAYLISTS_FILE}:`, error);
//         throw error;
//     }
// }

// async function saveImportedPlaylists(playlists) {
//     const data = { playlists: Array.isArray(playlists) ? playlists : [] };
//     await fs.writeFile(IMPORTED_PLAYLISTS_FILE, JSON.stringify(data, null, 2), 'utf-8');
//     return data;
// }
...
// // API: Get imported playlists
// app.get('/api/imported-playlists', async (req, res) => {
//     try {
//         const playlists = await loadImportedPlaylists();
//         res.json({ playlists });
//     } catch (error) {
//         console.error('Error getting imported playlists:', error);
//         res.status(500).json({ error: error.message });
//     }
// });
...
// // API: Delete imported playlist
// app.delete('/api/imported-playlists/:id', async (req, res) => {
//     try {
//         const playlistId = req.params.id;
//         const playlists = await loadImportedPlaylists();
...
//         res.json({ message: 'Playlist deleted', playlist: removed });
//     } catch (error) {
//         console.error('Error deleting imported playlist:', error);
//         res.status(500).json({ error: error.message });
//     }
// });
